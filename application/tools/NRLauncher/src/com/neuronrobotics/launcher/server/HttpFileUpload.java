...
public class HttpFileUpload extends Thread {
	...
	public HttpFileUpload(Socket client) {
	  ...
	  try {
        ...
        if (httpMethod.equals("GET")) {    
			...
			if (httpQueryString.equals("/")) {
   				  ...
   				  String responseString = HttpFileUpload.HTML_START + 
	...
	public void sendResponse (int statusCode, String responseString, boolean isFile) throws Exception {
		...
		if (isFile) {
			...
			responseString = HttpFileUpload.HTML_START + responseString + HttpFileUpload.HTML_END;
	...
	public static void main (String args[]) throws Exception {
		...
		while(true) {	                	   	      	
	            ...
	            (new HttpFileUpload(connected)).start();
        }      
	}
}

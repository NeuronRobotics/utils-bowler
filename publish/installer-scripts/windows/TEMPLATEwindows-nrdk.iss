...
var
  ...
  Result1 : Boolean;
begin
  if RegValueExists(JAVAARCH, 'SOFTWARE\JavaSoft\Java Runtime Environment', 'CurrentVersion') then
    begin
      RegQueryStringValue(JAVAARCH, 'SOFTWARE\JavaSoft\Java Runtime Environment', 'CurrentVersion', javaVersion);

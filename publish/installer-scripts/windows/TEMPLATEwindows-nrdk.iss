...
Name: {commondesktop}\BowlerStudio; Filename: {app}\BowlerStudioApp\BowlerStudio.exe; WorkingDir: {app}\BowlerStudioApp\; Comment: "Commonwealth Robotics BowlerStudio";IconFilename: {app}\BowlerStudioApp\splash.png;
